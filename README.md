...
| Time           | Activity                                                         | Link                                                                                                                                        |
|----------------|--------------------------------------------------------------------------------------------|---------------------------------------------------------------------------------------------------------------------------------------------|
| 09.00 - 10.00  | Lecture: non-linear machine learning in R, neural networks and decision trees                 | [Slides](https://github.com/NikolayOskolkov/R_course_TARGETWISE_2026/raw/main/slides/Lecture8_NeuralNetworks.pdf)                                                                                |
| 10.00 - 10.30  | Break                                                                                      |                                                                                                                    |
| 10.30 - 11.30  | Lecture: conceptual explanation of neural network and coding backpropagation              | [Slides](https://github.com/NikolayOskolkov/R_course_TARGETWISE_2026/raw/main/slides/Lecture8_NeuralNetworks.pdf)                                                                                |
| 11.30 - 12.30  | Lunch                                                                                      |                                                                                                                    |
